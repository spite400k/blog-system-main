...
import { GameMovie2airScheduleEndpoint } from 'components/features/settings/types/settings'

export const GameMovie2airScheduleEndpointField = (props: {
  schedule: GameMovie2airScheduleEndpoint
  endpoint: string
  index: number
