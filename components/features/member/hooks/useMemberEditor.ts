import { memberImageUploadState, memberPreviewState } from 'member/utils/atoms'
...
export const useMemberEditor = () => {
  const [uploadInfo, setUploadInfo] = useRecoilState(memberImageUploadState)
  const [isPreview, setPreviewMode] = useRecoilState(memberPreviewState)
