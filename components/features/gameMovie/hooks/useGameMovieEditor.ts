import {
  gameMovieImageUploadState,
  gameMoviePreviewState
} from '../utils/atoms'
...
export const useGameMovieEditor = () => {
  const [uploadInfo, setUploadInfo] = useRecoilState(gameMovieImageUploadState)
  const [isPreview, setPreviewMode] = useRecoilState(gameMoviePreviewState)
