...
import { CalendarScheduleEndpointField } from './calendar-schedule-field'

export const CalendarScheduleItem = (props: {
  ...
  const [schedule, setSchedule] = useState<CalendarScheduleEndpoint | null>(null)
