...
import { CalendarScheduleEndpoint } from 'components/features/settings/types/settings'

export const CalendarScheduleEndpointField = (props: {
  schedule: CalendarScheduleEndpoint
  endpoint: string
  index: number
